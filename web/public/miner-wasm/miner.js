 ...
 */
export function try_nonces(challenge, target, start_nonce, count) {
    ...
    const ret = wasm.try_nonces(ptr0, len0, ptr1, len1, start_nonce, count);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('miner_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
